...
save.add_argument("--output-path",default="output/maskrcnn.mp4",help="video save location")
save.add_argument("--no-save",action="store_true",help="do not save output video")
